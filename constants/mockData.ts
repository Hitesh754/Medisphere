...
export const mockMeals = {
  breakfast: {
    ...
    ingredients: ['Rolled oats', 'Blueberries', 'Almonds', 'Cinnamon'],
    imageUrl: 'https://images.pexels.com/photos/1132047/pexels-photo-1132047.jpeg',
  },
  lunch: {
    title: 'Grilled Salmon Salad',
    calories: 450,
    reason: 'Omega-3 rich, supports heart health',
    ingredients: [
      'Fresh salmon',
      'Mixed greens',
      'Cherry tomatoes',
  ...
  dinner: {
    title: 'Quinoa & Roasted Vegetables',
    calories: 380,
    reason: 'Low-sodium choice for blood pressure',
    ingredients: ['Quinoa', 'Broccoli', 'Bell peppers', 'Chickpeas'],
